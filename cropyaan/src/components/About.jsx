...
//       items: [t("about.card1_i1"), t("about.card1_i2"), t("about.card1_i3"), t("about.card1_i4")],
//     },
//     {
//       title: t("about.card2_title"),
//       items: [t("about.card2_i1"), t("about.card2_i2"), t("about.card2_i3"), t("about.card2_i4")],
//     },
//     {
//       title: t("about.card3_title"),
//       items: [t("about.card3_i1"), t("about.card3_i2"), t("about.card3_i3"), t("about.card3_i4")],
//     },
//     {
//       title: t("about.card4_title"),
//       items: [t("about.card4_i1"), t("about.card4_i2"), t("about.card4_i3"), t("about.card4_i4")],
//     },
//   ];
...
//       `}</style>
//       <GrainOverlay />
//       <div className="about-root dark:bg-[var(--bg-main)]" style={{ paddingTop: "68px" }}>
...
//           <FadeIn delay={0.1}>
//             <h3 className="display-font text-4xl font-bold mb-10 text-slate-900 dark:text-white">
...
//                   <div className="flex-shrink-0 mt-1.5 w-5 h-5 rounded-full flex items-center justify-center" style={{ background: "var(--green-8)", border: "1px solid rgba(34,197,94,0.2)" }}>
//                     <div className="bullet-dot w-2 h-2 rounded-full bg-green-500" style={{ transition: "all 0.3s" }} />
//                   </div>
//                   <p className="bullet-text text-slate-700 dark:text-zinc-300 text-base" style={{ transition: "color 0.3s", fontWeight: 400 }}>{item}</p>
//                 </div>
//               ))}
//             </div>
//           </FadeIn>
...
//         {/* ===== PLATFORM OFFERINGS ===== */}
//         <section className="dark:bg-[var(--bg-main)] py-24 px-6 lg:px-20 text-slate-900 dark:text-white relative overflow-hidden">
//           <div className="absolute pointer-events-none" style={{ width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle, rgba(34,197,94,0.04) 0%, transparent 70%)", top: "50%", left: "50%", transform: "translate(-50%,-50%)", filter: "blur(60px)" }} />
...
//                     style={{ background: "var(--overlay-25)", border: "1px solid var(--overlay-10)", transition: "box-shadow 0.4s, border-color 0.4s" }}
//                     onMouseEnter={e => e.currentTarget.style.borderColor = "var(--green-25)"}
//                     onMouseLeave={e => e.currentTarget.style.borderColor = "var(--overlay-7)"}
//                   >
...
//                       <h4 className="text-xl font-semibold text-slate-900 dark:text-white group-hover:text-green-400" style={{ transition: "color 0.3s", letterSpacing: "-0.01em" }}>
//                         {card.title}
//                       </h4>
//                     </div>
...
//                           <span className="text-slate-500 dark:text-zinc-400 group-hover:text-zinc-200 text-sm leading-relaxed" style={{ transition: "color 0.3s" }}>{item}</span>
//                         </li>
//                       ))}
//                     </ul>
//                   </div>
...
//         <section className="dark:bg-[var(--bg-main)] py-24 px-6 lg:px-20 text-slate-900 dark:text-white relative overflow-hidden">
//           <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1800&q=60')`, backgroundSize: "cover", backgroundPosition: "center", opacity: 0.04 }} />
...
//           <div className="max-w-6xl mx-auto relative z-10">
//             <FadeIn delay={0.05}>
//               <h3 className="display-font text-4xl md:text-5xl font-bold mb-20 text-center text-slate-900 dark:text-white">
...
//                     style={{ background: "var(--overlay-2)", border: "1px solid rgba(255,255,255,0.06)", transition: "all 0.4s" }}
//                     onMouseEnter={e => { e.currentTarget.style.background = "var(--green-4)"; e.currentTarget.style.borderColor = "var(--green-20)"; e.currentTarget.style.boxShadow = "0 0 40px rgba(34,197,94,0.07)"; }}
//                     onMouseLeave={e => { e.currentTarget.style.background = "var(--overlay-2)"; e.currentTarget.style.borderColor = "var(--overlay-6)"; e.currentTarget.style.boxShadow = "none"; }}
//                   >
//                     <div className="mb-8 relative">
//                       <div className="w-14 h-0.5 mx-auto rounded-full bg-green-500 group-hover:w-20" style={{ boxShadow: "0 0 12px rgba(34,197,94,0.5)", transition: "width 0.5s" }} />
//                     </div>
//                     <h3 className="display-font text-2xl font-bold mb-5 text-slate-900 dark:text-white group-hover:text-green-400" style={{ transition: "color 0.3s", letterSpacing: "-0.01em" }}>
//                       {item.label}
//                     </h3>
//                     <p className="text-slate-500 dark:text-zinc-400 text-base leading-relaxed group-hover:text-zinc-200" style={{ transition: "color 0.35s", fontWeight: 300 }}>
//                       {item.text}
//                     </p>
//                   </div>
//                 </FadeIn>
  ...
  return (
    <>
      <style>{`
        ...
        .glow-card:hover { box-shadow: 0 0 0 1px rgba(34,197,94,0.25), 0 8px 48px rgba(34,197,94,0.1); }
        .bullet-row:hover .bullet-dot { box-shadow: 0 0 12px rgba(34,197,94,0.9); transform: scale(1.3); }
        .bullet-row:hover .bullet-text { color: var(--color-text); }
      `}</style>
      <GrainOverlay />
      <div className="about-root dark:bg-[var(--bg-main)]" style={{ paddingTop: "68px" }}>
        ...
        <AgriSplit imageUrl="https://images.unsplash.com/photo-1500937386664-56d1dfef3854?q=80&w=1974&auto=format&fit=crop" imageAlt="Farmer in a field">
          <FadeIn delay={0.1}>
            <h2 className="display-font text-4xl md:text-5xl font-bold mb-6 text-slate-900 dark:text-white leading-tight">
              {t("about.hero_title1")}{" "}
              <span style={{ color: "#22c55e", textShadow: "0 0 32px rgba(34,197,94,0.35)" }}>
                {t("about.hero_title2")}
              </span>
          ...
          <FadeIn delay={0.2}>
            <p className="text-slate-500 dark:text-zinc-400 mb-5 leading-relaxed text-base" style={{ fontWeight: 300 }}>{t("about.hero_p1")}</p>
            <p className="text-slate-500 dark:text-zinc-400 mb-10 leading-relaxed text-base" style={{ fontWeight: 300 }}>{t("about.hero_p2")}</p>
          </FadeIn>
          <FadeIn delay={0.3}>
            <div className="grid grid-cols-2 gap-6 pt-8" style={{ borderTop: "1px solid rgba(34,197,94,0.18)" }}>
              {pillars.map((item, i) => (
                <div key={i}>
                  <p className="text-slate-900 dark:text-white font-semibold text-sm mb-1">{item.label}</p>
              ...
              {offerCards.map((card, i) => (
                <FadeIn key={i} delay={i * 0.1}>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-7">
                      <div className="w-1 h-7 rounded-full bg-green-500 group-hover:h-9 group-hover:shadow-lg" style={{ boxShadow: "0 0 12px rgba(34,197,94,0.5)", transition: "height 0.3s" }} />
                      <h4 className="text-xl font-semibold text-slate-900 dark:text-white group-hover:text-green-400" style={{ transition: "color 0.3s", letterSpacing: "-0.01em" }}>{card.title}</h4>
                    </div>
                    <ul className="space-y-3 pl-2">
                      {card.items.map((item, j) => (
                        <li key={j} className="flex items-start gap-3">
